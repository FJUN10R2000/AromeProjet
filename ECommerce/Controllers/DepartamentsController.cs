        ...
        public ActionResult Create([Bind(Include = "DepartamentsId,Name")] Departaments departaments)
        {
            if (ModelState.IsValid)
            {
                ...
                catch (System.Exception ex )
                {
                    ...
                    // if para retorna mensagem de erro de exclusão de departamentos
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                if(ex.InnerException != null && 
                    ...
                    ModelState.AddModelError(string.Empty, "Não é possivel remover o departamento, por que existe cidades relacionadas a ele, primeiro remova a cidades e volte a excluir. ");
